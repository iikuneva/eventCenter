    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.text}>
                ...
                <p>Event center is web application, which you can easily create your own events, send invitations by email and join public events, created by other users.</p>
                ...
                <p><strong>Private event</strong> is visible only for those who have a link to it. You have opportunity to create a list of atendees who do not need to be registered in the application, to whom you can send an invitation to the event by email. Atendees can confirm or decline your invitation and this will be reflected on the event page.</p>
                ...
                At Atendee List for private event - you will be able to send invitations by e-mail and monitor their response.</p>
            </div>
        </div>
    )
}
